...
const CategoryList = ({categories, onCategoryClick, onCategoryEditClick, onCategoryCreate}) => {
    ...
    return (
        <div className="w-1/5 h-h-192 border border-black rounded-2xl overflow-auto">
            ...
            <Modal isOpen={isEditModalOpen} onClose={closeEditModal}>
                <CategoryModifyForm cateno={selectedCategory} onClose={closeEditModal}/>
            </Modal>
